  ...
  var startSpinner = function (angleRef) {
      return function (velocityRef) {
          var spinner = function __do() {
              ...
              var v1 = Control_Monad_ST.readSTRef(velocityRef)();
              var v2 = Control_Monad_ST.readSTRef(angleRef)();
              var newAngle = {
                  x: v2.x + v1.x / 60.0, 
                  y: v2.y + v1.y / 60.0
              };
              ...
              Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_ST.writeSTRef(angleRef)(newAngle))();
